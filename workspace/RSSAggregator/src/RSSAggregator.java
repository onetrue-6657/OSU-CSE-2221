 ...
 * corresponding HTML output files. (CSE 2221 - Project 5)
 *
 * @author Zheng Ni
 *
 */
public final class RSSAggregator {
    ...
    private static void outputHeader(XMLTree channel, SimpleWriter out) {
        ...
        out.println("</title>\r\n" + "</head>\r\n" + "<body>\r\n" + " <h1>" + "<a href=\""
                + channel.child(link).child(0) + "\">" + channel.child(title).child(0)
                + "</a></h1>\r\n" + " <p>");
        if (description == -1) {
    ...
    private static void processFeed(String url, String file, SimpleWriter out) {
        ...
        out.println("<html>\r\n" + "  <head>\r\n" + "    <title>" + file + "</title>\r\n"
                ...
                + "    <ul>");
        for (int i = 0; i < xml.numberOfChildren(); i++) {
            XMLTree item = xml.child(i);
            String name = item.attributeValue("name");
            // String url1 = item.attributeValue("url");
            String feedsFile = item.attributeValue("file");
            out.println("      <li>" + "<a href=\"" + feedsFile + "\">" + name + "</a>"
                    + "</li>");
        }
        out.println("    </ul>\r\n" + "  </body>\r\n" + "</html>");
    }
    ...
    public static void main(String[] args) {
        ...
        XMLTree rssXML = new XMLTree1(url1);
        //  out.print("What name do you want for the RSS topics html file? ");
        //  String name1 = in.nextLine();
        SimpleWriter rssOut = new SimpleWriter1L("index.html");
        processFeed(url1, rssXML.attributeValue("title"), rssOut);

        for (int i = 0; i < rssXML.numberOfChildren(); i++) {
            XMLTree item = rssXML.child(i);
            String fileUrl = item.attributeValue("url");
            ...
            /**
             * Creates the output SimpleWriter method, printing everything in
             * the html file. If I input the name as "RSSReader", it will
             * generate a file called "RSSReader.html" in the project folder,
             * which can be used directly.
             */
            XMLTree xml = new XMLTree1(fileUrl);
        ...
        } // Iterates every feeds in the RSS and print them to different HTML files.
